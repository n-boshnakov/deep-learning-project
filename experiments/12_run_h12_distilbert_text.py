...
def main():
    ...
    print_evaluation_metrics(f"H12 - {MODEL_NAME}", history['val_f1'][-1], final_macro_prec)
    plot_training_history(history, f"H12_distilbert")
    
    artifacts_to_save = {
        "h12_distilbert_weights.pth": model
    }
