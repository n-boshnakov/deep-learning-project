...
def main():
    ...
    print_evaluation_metrics("H14 - roBERTa", val_f1, final_macro_prec)
    plot_training_history(history, "H14_roBERTa")
    artifacts_to_save = {
        "h14_roberta_weights.pth": model,
        "h14_metadata_preprocessor.pkl": preprocessor
    }
